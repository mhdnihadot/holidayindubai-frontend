...
const PublicFooter: React.FC = () => {
  return (
    <footer className="bg-white pt-8 pb-0 border-t border-gray-100 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
          {/* Brand & Apps */}
          <div className="col-span-1 md:col-span-1 flex flex-col items-start">
            <Link to="/" className="mb-6 block">
              <img src={logo1} alt="Holiday InDubai" className="h-12 w-auto object-contain" />
            </Link>

            {/* Social Icons */}
            <div className="flex items-center gap-3 mb-6">
              <a href="#" className="text-[#FF1645] hover:text-[#FF1645] transition-colors">
            ...
            <div className="flex flex-col gap-3">
              <a href="#" className="w-[140px] hover:opacity-90 transition-opacity">
          ...
          <div className="col-span-1">
            <h4 className="text-[15px] font-semibold text-gray-900 pb-2">Explore</h4>
          ...
          {/* Connect */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-semibold text-gray-900 pb-2">Connect</h4>
            <ul className="space-y-3 text-xs text-gray-500 font-normal">
          ...
          {/* Legal */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-semibold text-gray-900 pb-2">Legal</h4>
            <ul className="space-y-3 text-xs text-gray-500 font-normal">
          ...
          {/* Categories */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-semibold text-gray-900 pb-2">Categories</h4>
            <ul className="space-y-3 text-xs text-gray-500 font-normal">
              <li><Link to="/projects?category=top-must-do" className="hover:text-gray-900 transition-colors truncate block">Top & Must-Do Experiences</Link></li>
              <li><Link to="/projects?category=landmarks" className="hover:text-gray-900 transition-colors truncate block">Landmarks & Sightseeing</Link></li>
              <li><Link to="/projects?category=desert-nature" className="hover:text-gray-900 transition-colors truncate block">Desert & Nature Experiences</Link></li>
              <li><Link to="/projects" className="hover:text-gray-900 transition-colors mt-2 block text-black font-medium">View All</Link></li>
            </ul>
          </div>
        </div>
      </div>

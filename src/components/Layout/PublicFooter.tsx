...
const PublicFooter: React.FC = () => {
  return (
    <footer className="bg-white pt-16 pb-8 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col items-start">
            <Link to="/" className="font-bold text-xl tracking-tight text-black leading-tight mb-4">
              Holiday<br />InDubai
            </Link>
          ...
          <div className="col-span-1">
            <h4 className="text-[15px] font-bold text-gray-900 mb-5">Explore</h4>
          ...
          {/* Connect */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-bold text-gray-900 mb-5">Connect</h4>
            <ul className="space-y-4 text-[14px] text-gray-500 font-medium">
          ...
          {/* Legal */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-bold text-gray-900 mb-5">Legal</h4>
            <ul className="space-y-4 text-[14px] text-gray-500 font-medium">
          ...
          {/* Categories */}
          <div className="col-span-1">
            <h4 className="text-[15px] font-bold text-gray-900 mb-5">Categories</h4>
            <ul className="space-y-4 text-[14px] text-gray-500 font-medium">
              ...
              <li><Link to="/projects" className="hover:text-gray-900 transition-colors mt-2 block text-blue-600 font-semibold">View All</Link></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Dark Strip */}
      <div className="w-full h-12 bg-[#222222] mt-4"></div>
    </footer>
  );
};
